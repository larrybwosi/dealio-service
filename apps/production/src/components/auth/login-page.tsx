      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-white rounded-2xl shadow-lg mb-4 border border-amber-200">
            <div className="w-12 h-12 bg-linear-to-br from-amber-400 to-orange-500 rounded-lg flex items-center justify-center">
        ...
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full h-11 bg-linear-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 transition-all duration-200 shadow-md hover:shadow-lg text-white"
                disabled={isLoading || socialLoading !== null}
              >
                {isLoading ? (
                  <>
