      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h1 className="text-3xl font-bold tracking-tight text-slate-900">New Expense</h1>
              <p className="text-base text-slate-600 mt-1 max-w-2xl">
                Submit expenses for approval and reimbursement. Complete all required fields and attach receipts for
                faster processing.
              </p>
            </div>
          </div>
            ...
            <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow">
              <CardHeader className="border-b border-slate-100 bg-white">
                ...
                <CardDescription className="text-slate-600 mt-1">
                  Provide detailed information about your expense. Fields marked with{' '}
              ...
              <CardContent className="pt-6 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <Label htmlFor="description" className="font-semibold text-slate-900 flex items-center gap-1">
                      Description
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-slate-500">Be specific about the purpose and context of the expense</p>
                    </div>
                  </div>

                  <div className="space-y-3">
                    <Label htmlFor="amount" className="font-semibold text-slate-900 flex items-center gap-1">
                      Amount
                      <span className="text-red-500">*</span>
                    </Label>
                    <div className="space-y-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <Label className="font-semibold text-slate-900">Payment Method</Label>
                    <div className="space-y-1">
                      <Select
                      ...
                      <p className="text-xs text-slate-500">How was this expense paid?</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-slate-500">Where was this expense incurred?</p>
                    </div>
                  </div>
                </div>
                ...
                {/* Tags */}
                <div className="space-y-3">
                  <Label className="font-semibold text-slate-900">Tags</Label>
                  <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {formData.tags.map(tag => (
                          <Badge
                            key={tag}
                            variant="secondary"
                            className="h-8 px-3 bg-blue-100 text-blue-700 hover:bg-blue-200 border border-blue-200"
                          >
                    ...
                    <p className="text-xs text-slate-500">Use tags to categorize and find expenses easily later</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <h4 className="font-semibold text-slate-900">Expense Settings</h4>
                  ...
                  <div className="flex items-start space-x-4 p-4 rounded-lg border border-slate-200 hover:bg-slate-50 transition-colors">
                    <Checkbox
                      ...
                      onCheckedChange={checked => setFormData(prev => ({ ...prev, isReimbursable: !!checked }))}
                      className="mt-0.5 data-[state=checked]:bg-blue-600 data-[state=checked]:border-blue-600"
                    />
                    <div className="flex-1 space-y-1">
                      <Label htmlFor="reimbursable" className="font-medium text-slate-900 cursor-pointer">
                  ...
                  <div className="flex items-start space-x-4 p-4 rounded-lg border border-slate-200 hover:bg-slate-50 transition-colors">
                    ...
                    />
                    <div className="flex-1 space-y-1">
                      <Label htmlFor="billable" className="font-medium text-slate-900 cursor-pointer">
                        Billable to Client
                      </Label>
                      <p className="text-xs text-slate-600">
                  ...
                  <div className="flex items-start space-x-4 p-4 rounded-lg border border-slate-200 hover:bg-slate-50 transition-colors">
                    ...
                    />
                    <div className="flex-1 space-y-1">
                      <Label htmlFor="recurring" className="font-medium text-slate-900 cursor-pointer">
                        Recurring Expense
                      </Label>
                      <p className="text-xs text-slate-600">
              ...
              <CardContent className="pt-6 space-y-4">
                ...
                >
                  ...
                  <label htmlFor="file-upload" className="cursor-pointer block">
                    ...
                    <p className="text-slate-500 mb-3">Drag & drop files or click to browse</p>
                ...
                {validationErrors.attachments && (
                  <Alert className="border-red-200 bg-red-50">
                    ...
                    <AlertDescription className="text-red-800">{validationErrors.attachments}</AlertDescription>
                  </Alert>
                )}

                {formData.attachments.length > 0 && (
                  <div className="space-y-3">
                    <h4 className="font-semibold text-slate-900">Attached Files ({formData.attachments.length})</h4>
                    <div className="space-y-2">
              ...
              <CardContent className="pt-6 space-y-4">
                <div className="space-y-4">
                  <div className="flex justify-between items-baseline">
                    <span className="font-medium text-slate-700">Travel Budget</span>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-slate-600">{(100 - budgetUsagePercentage).toFixed(1)}% remaining</span>
                    <Badge
                      variant="secondary"
                      className={
                        budgetUsagePercentage > 90
                ...
                {willExceedBudget && (
                  <Alert className="border-red-200 bg-red-50">
                    ...
                    <AlertDescription className="text-red-800">
                      This expense exceeds your remaining budget by $
                      {(formData.amount - remainingBudget).toLocaleString()}
                    </AlertDescription>
                  </Alert>
                )}
